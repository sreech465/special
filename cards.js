...
for(i=0;i<users.length;i++){
    ...
    cardbody += `<div class=' card col-md-4 m-2 ' style="width:18rem ; id="ram">
    <div class='card-body' style = "text-align:center">
    <img src = ${users[i].image}></br></br>
    <p> ID: ${users[i].id} </p>
    <p class='dog'> TITLE: ${users[i].title} </p>
    <p class='fgh'> PRICE: ${users[i].price} </p>
    <p class='fox'> DESCRIPTION: ${users[i].description} </p>
    <p> CATEGORY: ${users[i].category} </p>
    <p class='cat'> RATE: ${users[i].rating.rate} </p>
    <p> COUNT: ${users[i].rating.count} </p>
    </div>
    </div>`
}
